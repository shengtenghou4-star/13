...
OUTPUT_ROOT = Path("outputs/real-ppm-batch")
DEPTHS = (0.00005, 0.0001, 0.0002)
...
summary = {
    "experiment": "HOU-EARTH 50-200 ppm real TESS sensitivity sweep",
...
if not all_trials:
    raise SystemExit("No real TESS ppm target completed")
